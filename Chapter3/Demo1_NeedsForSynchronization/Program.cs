...
Account account = new();
var credit100 = Task.Run(() => account.Credit(100));
var debit500 = Task.Run(() => account.Debit(500));
var credit200 = Task.Run(() => account.Credit(200));
var credit300 = Task.Run(() => account.Credit(300));
var debit100 = Task.Run(() => account.Debit(100));
